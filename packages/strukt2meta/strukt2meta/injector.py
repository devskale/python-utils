...
class JSONInjector:
    ...
    def _load_params(self, params_file: str) -> Dict[str, Any]:
        ...
        required_fields = ['input_path', 'prompt', 'json_inject_file', 'target_filename', 'injection_schema']
    ...
    def _load_target_json(self) -> Dict[str, Any]:
        ...
        if not os.path.exists(json_file_path):
            raise FileNotFoundError(f"Target JSON file not found: {json_file_path}")
    ...
    def _inject_metadata(self, json_data: Dict[str, Any], metadata: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if file_entry is None:
            raise ValueError(f"Target file not found: {self.params['target_filename']}")
        ...
        try:
            ...
            if self.params.get('validation_strict', True):
                if not self._validate_metadata(metadata):
                    raise ValueError("Generated metadata does not match required schema")
            ...
            print(f"Successfully injected metadata into: {self.params['json_inject_file']}")
